//
//  Copyright (c) 2012-2018  Finnbarr P. Murphy.  All rights reserved.
//
//  Display UEFI Secure Boot certificates (PK, KEK, DB, DBX)
// 
//  License: BSD License
//
...
#define UTILITY_VERSION L"20180226"
#undef DEBUG
                   ...
                   CHAR16 *name )
{
    ...
    UINTN Index, DataSize = len, CertCount = 0;
